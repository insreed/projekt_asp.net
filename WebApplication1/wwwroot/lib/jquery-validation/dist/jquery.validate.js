...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Popraw wprowadzone dane.",
		...
		digits: "Podaj tylko liczby.",
		equalTo: "Wprowadź tę samą wartość jeszcze raz.",
		maxlength: $.validator.format( "Wprowadź nie więcej niż {0} znaków." ),
		minlength: $.validator.format( "Wprowadź przynajmniej {0} znaków." ),
		rangelength: $.validator.format( "Wprowadź wartość pomiędzy {0} i {1} znaków." ),
